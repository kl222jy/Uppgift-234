...
Utan att använda sig av något system för att hantera dokumentationen är det omständligt att samarbeta och strukturera upp informationen överskådligt. 
...
*Projektledare - Manager, Administration, Projektmedlem
*Projektmedlem - Har insikt i projektet, troligen dålig insikt i projektdokumentation.

Projektmedlem innefattar alla som arbetar i projektform och är därför en skara som inte riktigt går att specificera.
Vi kan dock anta att alla som uppsöker ett system som detta har viss datorvana samt ett behov av att arbeta i projektform och vill förenkla/effektivisera denna process.
