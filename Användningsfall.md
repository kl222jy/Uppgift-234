...
Projektledaren väljer att ställa in information som ska vara tillgänglig för kund, systemet presenterar möjliga alternativ, projektledaren väljer ibland alternativen, systemet sparar valda inställningar
##AF2.1 - Lägga till dokument
##AF2.1.1 - Vision
##AF2.1.2 - Krav
##AF2.1.3 - Kravspecifikation
##AF2.1.4 - Användningsfall
##AF2.1.5 - Testfall
##AF2.1.6 - Testrapport
##AF2.1.7 - Tidsplanering
##AF2.1.8 - Risk
##AF2.1.9 - Övrigt
##AF2.2 - Hantera dokument
En projektmedlem väljer att hantera ett dokument, systemet öppnar dokumentet och användaren ändrar i dokumentet, användaren väljer att spara ändringarna och systemet sparar ändringarna
...
##F1 - Inloggning
##Anv1 - Grafisk utformning
##Till1 - Handikappanpassning